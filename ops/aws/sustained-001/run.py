#!/usr/bin/env python3
"""Plan or execute the sustained mixed-traffic experiment EXP-2026-006."""
...
PRIOR_SPEND_USD = 3.8689
EXPERIMENT_TOKEN = "exp-2026-006-sustained"
...
def main() -> int:
    ...
    result = execute_aws_run(
        ...
        project=root,
        output_dir=root / "ops/evidence/EXP-2026-006",
