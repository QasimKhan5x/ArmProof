#!/usr/bin/env python3
"""Plan or execute clean-instance reproduction EXP-2026-005."""
...
PRIOR_SPEND_USD = 3.1632
EXPERIMENT_TOKEN = "exp-2026-005-reproduction"
...
def main() -> int:
    ...
    plan = make_plan(
        "EXP-2026-005", instance_type="c8g.4xlarge", region="us-east-1",
    ...
    result = execute_aws_run(
        ...
        output_dir=root / "ops/evidence/EXP-2026-005",
