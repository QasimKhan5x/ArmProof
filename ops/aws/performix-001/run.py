#!/usr/bin/env python3
"""Plan or execute required Arm Performix experiment EXP-2026-010."""
...
PRIOR_SPEND_USD = 10.7878
EXPERIMENT_TOKEN = "exp-2026-010-performix"
...
def main() -> int:
    ...
    assets = {
        "RUNTIME_CHECKPOINTS": checkpoint,
    ...
    result = execute_aws_run(
        ...
        project=root,
        output_dir=root / "ops/evidence/EXP-2026-010",
