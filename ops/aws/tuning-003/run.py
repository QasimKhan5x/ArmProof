#!/usr/bin/env python3
"""Plan or execute the simplified memory-recipe confirmation."""
...
PRIOR_SPEND_USD = 14.4716
EXPERIMENT_TOKEN = "exp-2026-017-memory-confirmation"
...
def main() -> int:
    ...
    plan = make_plan(
        "EXP-2026-017", instance_type="c8g.4xlarge", region="us-east-1",
    ...
    result = execute_aws_run(
        ...
        output_dir=root / "ops/evidence/EXP-2026-017",
        guest_template=root / "ops/aws/tuning-003/guest.sh",
