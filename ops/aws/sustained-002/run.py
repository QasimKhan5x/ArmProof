#!/usr/bin/env python3
"""Plan or execute isolated sustained-capacity experiment EXP-2026-007."""
...
PRIOR_SPEND_USD = 6.3205
EXPERIMENT_TOKEN = "exp-2026-007-isolated-sustained"
...
def main() -> int:
    ...
    result = execute_aws_run(
        ...
        project=root,
        output_dir=root / "ops/evidence/EXP-2026-007",
