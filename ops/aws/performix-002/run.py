#!/usr/bin/env python3
"""Plan or execute cloud-compatible Arm Performix experiment EXP-2026-011."""
...
PRIOR_SPEND_USD = 10.8618
EXPERIMENT_TOKEN = "exp-2026-011-performix-cloud"
...
def main() -> int:
    ...
    plan = make_plan(
        "EXP-2026-011", instance_type="c8g.4xlarge", region="us-east-1",
        maximum_runtime_minutes=120, volume_gib=60,
    ...
    result = execute_aws_run(
        ...
        output_dir=root / "ops/evidence/EXP-2026-011",
        guest_template=root / "ops/aws/performix-001/guest.sh",
        immutable_assets=assets, poll_seconds=15,
    )
