#!/usr/bin/env python3
"""Plan or execute exclusive sustained-capacity experiment EXP-2026-008."""
...
PRIOR_SPEND_USD = 6.3626
EXPERIMENT_TOKEN = "exp-2026-008-exclusive-sustained"
...
def main() -> int:
    ...
    result = execute_aws_run(
        ...
        project=root,
        output_dir=root / "ops/evidence/EXP-2026-008",
