#!/usr/bin/env python3
"""Plan or execute paired boundary confirmation EXP-2026-009."""
...
PRIOR_SPEND_USD = 8.8144
EXPERIMENT_TOKEN = "exp-2026-009-paired-boundary"
...
def main() -> int:
    ...
    plan = make_plan(
        "EXP-2026-009", instance_type="c8g.4xlarge", region="us-east-1",
        maximum_runtime_minutes=250, volume_gib=60,
    ...
    result = execute_aws_run(
        ...
        project=root,
        output_dir=root / "ops/evidence/EXP-2026-009",
