#!/usr/bin/env python3
"""Plan or execute the identity-bound minimum-capacity confirmation."""
...
PRIOR_SPEND_USD = 12.4369
EXPERIMENT_TOKEN = "exp-2026-014-identity-bound-capacity"
...
def main() -> int:
    ...
    plan = make_plan(
        "EXP-2026-014", instance_type="c8g.4xlarge", region="us-east-1",
    ...
    result = execute_aws_run(
        ...
        project=root,
        output_dir=root / "ops/evidence/EXP-2026-014",
