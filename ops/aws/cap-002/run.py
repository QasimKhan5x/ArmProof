#!/usr/bin/env python3
"""Plan or execute corrective fixed-SLO experiment EXP-2026-004."""
...
PRIOR_SPEND_USD = 2.4575
EXPERIMENT_TOKEN = "exp-2026-004-capacity"
...
def main() -> int:
    ...
    plan = make_plan(
        "EXP-2026-004", instance_type="c8g.4xlarge", region="us-east-1",
    ...
    result = execute_aws_run(
        ...
        output_dir=root / "ops/evidence/EXP-2026-004",
